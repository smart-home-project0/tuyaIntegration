...
console.log(getStatusByDeviceId("bfcca327de01d70a53yjvi"));
console.log(toogleDevice("bfcca327de01d70a53yjvi", true));
console.log(getDeviceInfo("bfcca327de01d70a53yjvi"));
console.log(updateDeviceName("bfcca327de01d70a53yjvi", "שקע אצל אביטל!"));
